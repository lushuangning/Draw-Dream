...
import cuit.drawdream.SwApplication;
import cuit.drawdream.bean.response.ResponseError;
import cuit.drawdream.utils.widget.ToastUtils;
...
public abstract class BaseViewModel extends BaseObservable {
    ...
    protected static SwApplication getApplication() {
        if (null == mApp) {
